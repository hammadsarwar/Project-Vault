...
enemy1 = Person("Nigga1  :", 1250, 130, 560, 325, enemy_spells, [])
enemy2 = Person("Nigga🥷  :", 18340, 701, 525, 25, enemy_spells, [])
enemy3 = Person("Nigga2  :", 1250, 130, 560, 325, enemy_spells, [])
    ...
    for enemy in enemies:
        ...
        if enemy_choice == 0:
            ...
            if spell.type == "white":
                ...
                target = random.rangrange(0, 3)
                players[target].take_damage(magic_dmg)


                print(bcolors.OKBLUE + enemy.name.replace(" ", "") + "'s" + spell.name + " deals", str(magic_dmg), "points of damage to " + enemies[enemy].name.replace(" ", "") + bcolors.ENDC)
